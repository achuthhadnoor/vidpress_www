          ...
          <div className="flex flex-1 flex-col pt-20 dark:text-neutral-200 gap-4">
            ...
            <div>
              ...
              <input
                ...
                placeholder="compresss_XXXX-XXXX-XXXX-XXXX..."
                id="license_input"
                value={licenseKey}
                onChange={(e: any) => {
